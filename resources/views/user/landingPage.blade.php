...
<body>
  <div class="nav-bar">
    <nav class="main-nav">
      <img src="{{ asset('Assets/official-logo-green.png') }}" class="logo-img" alt="logo">
      <ul class="nav">
        <li class="scroll-to-section"><a href="#" class="active">Home</a></li>
        <li class="scroll-to-section"><a href="/termsAndCondition">Terms and Condition</a></li>
        <li><div class="gradient-button"><a id="modal_trigger" href="/login"><i class="fa fa-sign-in-alt"></i> Login Now</a></div></li> 
      </ul>        
    </nav>
  </div>
